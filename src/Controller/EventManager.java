...
//			rs = st.executeQuery("select * from Events;");
			...
			while (rs.next()) {
				...
				eventArray.add(new Event(eventID, userID, categoryID,
	...
	public boolean addEvent(Event event) {
		...
		String strsnt = "insert into Events (`event-title`, `description`, `start-date`, `end-date`, `end-time`, `start-time`, `location-name`, `address`, `city`, `state`, `category-id`, `user-id`, `zip`, `lng`, `lat`) values ('"
				+ event.getEventTitle()
				+ "','"
